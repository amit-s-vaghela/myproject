...
class CmsBestSeller implements \SoftWebPos\MobileApi\Api\CmsBestSeller
{
    protected $logger;
    ...
    public function __construct(
        ...
        \Evincemage\BestSellerProduct\Block\BestSellerProduct $ProductCollection,
    ...
    public function getApiData()
    {
        $response = [];
        try {
            $data = $this->ProductCollection->getBestSellerProductCollection();
